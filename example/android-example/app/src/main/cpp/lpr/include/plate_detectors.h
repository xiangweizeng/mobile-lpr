...
namespace pr{
    ...
    static void fix_align_detector(AAssetManager* mgr, const std::string &path, AlignPlateDetectorConfig &config)
    {
        config.mgr = mgr;
    ...
    static void fix_mtcnn_detector(AAssetManager* mgr, const std::string &path, MtcnnPlateDetectorConfig &config){
        config.mgr = mgr;
        ...
        fix_align_detector(mgr, path, config.align);
    }
    ...
    static void fix_ssd_detector(AAssetManager* mgr, const std::string &path, SSDPlateDetectorConfig &config){
        config.mgr = mgr;
    ...
    static void fix_lffd_detector(AAssetManager* mgr, const std::string &path, LFFDPlateDetectorConfig &config){
        config.mgr = mgr;
        config.param = path + "/" + config.param;
        config.bin = path + "/" + config.bin;
        fix_align_detector(mgr, path, config.align);
