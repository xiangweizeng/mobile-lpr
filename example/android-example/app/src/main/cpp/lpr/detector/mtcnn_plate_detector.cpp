...
namespace pr {
    ...
    MtcnnPlateDetector::MtcnnPlateDetector(MtcnnPlateDetectorConfig &config) :
            ...
            proposal(config.mgr, config.proposal_param, config.proposal_bin, 120, 48, config.proposal_iou, config.proposal_prob),
            filter(config.mgr, config.filter_param, config.filter_bin, 60, 24, config.proposal_iou, config.filter_prob) {
