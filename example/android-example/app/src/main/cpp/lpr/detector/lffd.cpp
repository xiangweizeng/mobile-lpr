...
LFFD::LFFD(AAssetManager* mgr, std::string param, std::string bin, int num_thread_) {
    ...
    lffd.load_param(mgr, param_file_name.data());
    lffd.load_model(mgr, bin_file_name.data());
}
